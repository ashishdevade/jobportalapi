	...
	if (Object.keys(req.body).length > 0) {
		...
		if (dataset.job_id == 0) {
			var posting_data = {
				...
				location_state_id: dataset.location_state_id,
				location_state: dataset.location_state_name,
				location_city_id: dataset.location_city_id,
				location_city: dataset.location_city_name,
